...
const Hero = () => {
  return (
    <div className="flex flex-col items-center sm:items-start md:flex-row justify-around gap-y-10 md:gap-y-0 h-[680px] sm:h-[600px] md:h-[450px] lg:h-[500px] xl:h-[450px] w-[90%] sm:w-full xl:w-[1200px] pt-20 mb-20 mx-auto">
